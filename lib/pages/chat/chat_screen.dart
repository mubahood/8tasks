...
class _ChatScreenState extends State<ChatScreen> {
  ...
  List<String> _simpleChoice = ["Report user", "Clear chat"];
  ...
  Future<void> start_live_check() async {
    if (!live_check_is_loading) {
      ...
      print("========== found ===> ${live_chats.length} <=======");

      live_chats.forEach((element) {
        print(
            "========== found ===> SENDER: ${element.sender} RECEIVER: ${element.receiver} THREAD: ${element.thread}<=======");
